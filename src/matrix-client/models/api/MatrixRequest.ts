...
import {
  ...
  MatrixRoomCreateResponse,
} from './MatrixRoomCreate';
import {
  MatrixRoomInviteRequest,
  MatrixRoomInviteResponse,
} from './MatrixRoomInvite';
import {
  MatrixRoomJoinRequest,
  MatrixRoomJoinResponse,
} from './MatrixRoomJoin';
import {
  MatrixEventSendRequest,
  MatrixEventSendResponse,
} from './MatrixEventSend';
...
export type MatrixRequestParams<T> = T extends MatrixSyncResponse
  ? MatrixSyncRequestParams
  : never;
